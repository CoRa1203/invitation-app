      ...
      <div className="container">
        ...
        <div className="content">
          ...
          <div className="button-container3">
            <button
              onClick={() =>
                openModal("Дресс-код", <img src={hoverPhoto3} alt="дресс-код" />, [], 'Скажем "нет" трусикам! (почему? см.раздел "Программа"). А вообще надевайте, что хотите.')
              }
          ...
          <div className="button-container5">
            <button
              onClick={() =>
                openModal("Доп.люди", <img src={hoverPhoto5} alt="доп.люди" />, [], 'Вход строго по приглашению, но если с вами будут горящие азиаты или 2Д мужики, то Welcome в мою кроватку')
              }
        ...
        <div className="lowerInfo">
          <div className="lowerInfoContent">
            <h1>Придешь посмотреть на соску-нереалку? </h1>
